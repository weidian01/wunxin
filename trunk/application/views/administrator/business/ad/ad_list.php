            ...
            <div class="tab-content default-tab" id="tab1">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/administrator/business_ad/adEdit/<?php echo $v['ad_id'];?>" title="编辑广告"><img src="/images/icons/pencil.png" alt="编辑广告"/></a>
                            <a href="/administrator/business_ad/adDelete/<?php echo $v['ad_id'].'/'.$current_page;?>" title="删除广告"><img src="/images/icons/cross.png" alt="删除广告"/></a>
                        </td>
                    </tr>
                        <?php }?>
                    </tbody>
