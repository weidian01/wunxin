            ...
            <div class="tab-content default-tab" id="tab1">
                <table>
                    ...
                    <tr>
                        ...
                        <td><?=$v['create_time'];?></td>
                        <td>
                            <a href="/administrator/business_promotion_product/p_create/<?php echo $v['promotion_id'];?>" title="为此活动添加产品">加产品</a>
                            <a href="/administrator/business_promotion_category/create/<?php echo $v['promotion_id'];?>" title="为此活动添加产品">加分类</a><br/>
                            <a href="/administrator/business_promotion/edit/<?php echo $v['promotion_id'];?>" title="编辑"><img src="/images/icons/pencil.png" alt="编辑"></a>
                            <a href="/administrator/business_promotion/delete/<?php echo $v['promotion_id'];?>" title="删除"><img src="/images/icons/cross.png" alt="删除"/></a>
                        </td>
                    </tr>
                        <?php }?>
                    </tbody>
