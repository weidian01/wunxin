    ...
    <div class="u-right">
        ...
        <div class="u-r-box">
            ...
            <table class="tab6" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="o-list">
                    <td width="16%" height="26" align="center">留言编号</td>
                    <td width="15%" align="center">设计师头像</td>
                    <td width="25%" align="center">设计师昵称</td>
                    <td width="10%" align="center">留言内容</td>
                    <td width="17%" align="center">留言时间</td>
                ...
                <tr>
                    ...
                    <td ><img src="<?=config_item('static_url')?>upload/designer/<?=intToPath($v['be_uid'])?>icon.jpg" alt=""/></td>
                    ...
                    <!--<td align="center">
                        <a href="javascript:void(0);" onclick="deleteProductComment(<?php echo $v['message_id'];?>)">删除</a>
                    </td>-->
                </tr>
                <?php }?>
                <!--
