 ...
 */
 (function(g, h) {
    ...
    c.fn.init = function(b, d) {
        var e, d = d || document;
        if (!b) return this;
        if (b.nodeType) return this[0] = b,
        this;
        if ("body" === b && d.body) return this[0] = d.body,
        this;
        if ("head" === b || "html" === b) return this[0] = d.getElementsByTagName(b)[0],
        this;
        if ("string" === typeof b && (e = t.exec(b)) && e[2]) return (e = d.getElementById(e[2])) && e.parentNode && (this[0] = e),
        this;
    ...
    c.fn.find = function(b) {
        var d = this[0],
        e = b.split(".")[1];
        if (e) if (document.getElementsByClassName) e = d.getElementsByClassName(e);
        else {
    ...
    c.removeData = function(b, d) {
        ...
        b.removeAttribute ? b.removeAttribute(a) : b[a] = null
    };
    c.uuid = 0;
    c.cache = {};
    ...
    c.event = {
        add: function(b, d, e) {
            ...
            if (!a.handler) a.elem = b,
            a.handler = f.handler(a),
            b.addEventListener ? b.addEventListener(d, a.handler, !1) : b.attachEvent("on" + d, a.handler)
        },
        remove: function(b, d, e) {
            ...
            if (y) if (d) {
                if (f = y[d]) {
                    k = f.listeners;
                    if (e) for (a = 0; a < k.length; a++) k[a] === e && k.splice(a--, 1);
                    else f.listeners = [];
    ...
    c.cleanData = function(b) {
        for (var d = 0, e, a = b.length, f = c.event.remove, k = c.removeData; d < a; d++) e = b[d],
        f(e),
        k(e)
    };
    c.isReady = !1;
    ...
    c.bindReady = function() {
        if (!v) {
            ...
            g.addEventListener("load", c.ready, !1);
    ...
    c.ajax = function(b) {
        ...
        d.onreadystatechange = function() {
            if (4 === d.readyState && 200 === d.status) b.success && b.success(d.responseText),
    ...
    c.fn.animate = function(b, d, e, a) {
        ...
        function(a, b) {
            ...
            j = parseFloat(y[2]);
            u = y[3];
            if ("height" === a || "width" === a) j = Math.max(0, j),
            k = [f.style.overflow, f.style.overflowX, f.style.overflowY];
            w.custom(i, j, u)
        });
    ...
    c.fx.tick = function() {
        for (var b = c.timers, d = 0; d < b.length; d++) ! b[d]() && b.splice(d--, 1); ! b.length && c.fx.stop()
    };
    c.fx.stop = function() {
...
(function(g, h, n) {
    ...
    b.fn = b.prototype = {
        ...
        title: function(a) {
            ...
            c = b.wrap,
            b = b.title;
            if (a === n) return b[0]; ! 1 === a ? (b.hide().html(""), c.addClass("aui_state_noTitle")) : (b.show().html(a || ""), c.removeClass("aui_state_noTitle"));
            return this
        },
        position: function(a, b) {
            ...
            p = d.offsetHeight,
            d = d.style;
            if (a || 0 === a) if (this._left = -1 !== a.toString().indexOf("%") ? a: null, a = this._toNumber(a, o - m), "number" === typeof a) a = c ? a += i: a + g,
            d.left = Math.max(a, g) + "px";
            else if ("string" === typeof a) d.left = a;
            if (b || 0 === b) if (this._top = -1 !== b.toString().indexOf("%") ? b: null, b = this._toNumber(b, h - p), "number" === typeof b) b = c ? b += j: b + e,
            d.top = Math.max(b, e) + "px";
            else if ("string" === typeof b) d.top = b;
            if (a !== n && b !== n) this._follow = null,
        ...
        size: function(a, b) {
            ...
            g = d[0].style,
            e = i[0].style;
            if (a) if (this._width = -1 !== a.toString().indexOf("%") ? a: null, c = l.width() - d[0].offsetWidth + i[0].offsetWidth, a = c = this._toNumber(a, c), "number" === typeof a) g.width = "auto",
            e.width = Math.max(this.config.minWidth, a) + "px",
            g.width = d[0].offsetWidth + "px";
            else if ("string" === typeof a) e.width = a,
            "auto" === a && d.css("width", "auto");
            if (b) if (this._height = -1 !== b.toString().indexOf("%") ? b: null, d = l.height() - d[0].offsetHeight + i[0].offsetHeight, b = d = this._toNumber(b, d), "number" === typeof b) e.height = Math.max(this.config.minHeight, b) + "px";
        ...
        follow: function(a) {
            var b, c = this.config;
            if ("string" === typeof a || a && 1 === a.nodeType) b = g(a),
            a = b[0];
        ...
        button: function() {
            ...
            function(b, c) {
                ...
                a._focus = g(i).addClass("aui_state_highlight"),
                a.focus();
        ...
        _ie6PngFix: q ?
        function() {
            for (var a = 0, c, d, e = b.defaults.path + "/skins/", g = this.DOM.wrap[0].getElementsByTagName("*"); a < g.length; a++) if (c = g[a], d = c.currentStyle.png) d = e + d,
            c = c.runtimeStyle,
            c.backgroundImage = "none",
            c.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + d + "',sizingMethod='crop')"
        }: g.noop,
        _ie6SelectFix: q ?
        function() {
            var a = this.DOM.wrap,
        ...
        _runScript: function(a) {
            for (var b, c = b = 0, a = a.getElementsByTagName("script"), d = a.length, e = []; b < d; b++) if ("text/dialog" === a[b].type) e[c] = a[b].innerHTML,
            c++;
        ...
        _addEvent: function() {
            ...
            function(a) {
                ...
                if (a === e.close[0]) return b._click(c.cancelVal),
                !1;
...
(function(g) {
    ...
    n = function(g) {
        ...
        h.onstart = function() {
            ...
            c.bind("dblclick", h.end); ! r && s ? k.bind("losecapture", h.end) : p.bind("blur", h.end);
            l && k[0].setCapture();
        ...
        h.onmove = function(a, c) {
            ...
            g = Math.max(m.minX, Math.min(m.maxX, a + x)),
            k = Math.max(m.minY, Math.min(m.maxY, c + b)),
            h.left = g + "px",
            h.top = k + "px";
            v();
            e._ie6SelectFix()
        ...
        h.onend = function() {
            c.unbind("dblclick", h.end); ! r && s ? k.unbind("losecapture", h.end) : p.unbind("blur", h.end);
    ...
    function(c) {
        ...
        if (g) {
            ...
            p = g.config,
            g = g.DOM;
            if (!1 !== p.drag && l === g.title[0] || !1 !== p.resize && l === g.se[0]) return h = h || new artDialog.dragEvent,
            n(c),
            !1
        }
    })
