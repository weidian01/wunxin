...
cart.init = function ()
{
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        html += '<input name="textfield" type="text" class="gnum" id="textfield" value="'+data[i].product_num+'"/>';
        html += '&nbsp;<a href="#"><img src="images/plus.gif" width="11" height="11"/></a>';
        html += '</td>';
    ...
    for (var i in data) {
        ...
        html += '<input name="product_num" type="text" class="gnum" id="product_num" value="'+data[i].product_num+'" maxlength="3" onchange="cart.changeQuantity('+i+', 2)"/>';
    ...
    html += '<div class="empty"><a href="javascript:void(0)" onclick="cart.emptyCart()">清空购物车</a></div>' +
		'<div class="storage"> <div class="st-d"><a href="#">寄存购物车</a></div> <div class="st-a"><a href="#">取出购物车</a></div> </div>' ;
    html += '<div class="post-btn">';
    html += '<a href="#"><img src="images/buy_bg_14.gif" alt="继续购物" width="115" height="32"/></a>&nbsp;&nbsp;';
