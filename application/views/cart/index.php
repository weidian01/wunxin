    ...
    <div class="shopping-cart">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td width="49%">
                    <a class="gn" href="#">Bessie OL气质荷叶边条纹短裙 <img src="images/buy_bg_10.gif" width="31" height="13"/></a><br/>
                    <span class="font2">GZ26052909-S</span><br/>
                    <a href="#">收藏</a>&nbsp;&nbsp;&nbsp;<a href="#">删除</a>
                </td>
                <td align="center">39.00</td>
                <td align="center">
                    <input name="textfield" type="text" class="gnum" id="textfield" value="1"/>
                    &nbsp;<a href="#"><img src="images/plus.gif" width="11" height="11"/></a>
                </td>
            ...
            <tr>
                ...
                <td align="center">
                    <input name="textfield2" type="text" class="gnum" id="textfield2" value="1"/>
                    &nbsp;<a href="#"><img src="images/plus.gif" alt="" width="11" height="11"/></a>
                </td>
                <td align="center"><span class="font2">—</span></td>
            ...
            <tr>
                ...
                <td align="center">
                    <input name="textfield3" type="text" class="gnum" id="textfield3" value="1"/>
                    &nbsp;<a href="#"><img src="images/plus.gif" alt="" width="11" height="11"/></a>
                </td>
                <td align="center"><span class="font2">—</span></td>
            ...
            <tr>
                ...
                <td colspan="5" style="border-bottom:1px solid #a5afc3;">
                    <div class="gsum">
                        产品数量总计：<span class="font1">3</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        赠送积分总计：<span class="font1">147</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        花费积分总计：<span class="font1">0</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        商品金额总计：<span class="font1">422.00</span>
                    </div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                    <div class="empty"><a href="#">清空购物车</a></div>
                    <div class="post-btn">
                        <a href="#"><img src="images/buy_bg_14.gif" alt="继续购物" width="115" height="32"/></a>&nbsp;&nbsp;
                        <a href="#"><img src="images/buy_bg_16.gif" width="126" height="32" alt="去结算"/></a>
                    </div>
                </td>
            </tr>
        </table>
