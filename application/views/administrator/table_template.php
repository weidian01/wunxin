<div class="content-box-content">
    <div class="tab-content default-tab" id="tab1">
        ...
        <div class="notification attention png_bg"><a href="#" class="close">
            <img src="<?=config_item('static_url')?>/images/icons/cross_grey_small.png" title="Close this notification" alt="close"/></a>
        ...
        <table>
            ...
            <tr>
                <td colspan="6">
                    ...
                    <div class="pagination"><a href="#" title="First Page">&laquo; First</a><a href="#"
                        ...
                        <a href="#" class="number" title="4">4</a> <a href="#" title="Next Page">Next &raquo;</a><a
            ...
            <tr>
                ...
                <td>
                    <!-- Icons -->
                    <a href="#" title="Edit"><img src="<?=config_item('static_url')?>/images/icons/pencil.png" alt="Edit"/></a> <a href="#"
                                                                                                     title="Delete">
                    <img src="<?=config_item('static_url')?>/images/icons/cross.png" alt="Delete"/></a> <a href="#" title="Edit Meta"><img
                    src="<?=config_item('static_url')?>/images/icons/hammer_screwdriver.png" alt="Edit Meta"/></a></td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox"/>
                ...
                <td>
                    <!-- Icons -->
                    <a href="#" title="Edit"><img src="<?=config_item('static_url')?>/images/icons/pencil.png" alt="Edit"/></a> <a href="javascript:void(0);" title="Delete">
