            ...
            <div class="tab-content default-tab" id="tab1">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/administrator/business_card_model/cardModelEdit/<?php echo $v['model_id'];?>" title="编辑卡模型"><img src="/images/icons/pencil.png" alt="编辑卡模型"/></a>
                            <a href="/administrator/business_card_model/cardModelDelete/<?php echo $v['model_id'].'/'.$current_page;?>" title="删除卡模型"><img src="/images/icons/cross.png" alt="删除卡模型"/></a>
                        </td>
                    </tr>
                        <?php }?>
                    </tbody>
