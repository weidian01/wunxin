            ...
            <div class="tab-content default-tab" id="tab1">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/administrator/business_mail_subscribe/mailSubscribeEdit/<?php echo $v['id'].'/'.$current_page;?>" title="修改邮件订阅"><img src="/images/icons/pencil.png" alt="修改邮件订阅"></a>
                            <a href="/administrator/business_mail_subscribe/mailSubscribeDelete/<?php echo $v['id'].'/'.$current_page;?>" title="删除邮件订阅"><img src="/images/icons/cross.png" alt="删除邮件订阅"></a>
                        </td>
                    </tr>
                        <?php }?>
                    </tbody>
