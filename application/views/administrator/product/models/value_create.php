    ...
    <div class="content-box">
        ...
        <div class="content-box-content">
            ...
            <div class="tab-content default-tab" id="tab1">
                <form action="<?=site_url('administrator/product_models/value_save')?>" method="post">
                    <fieldset>
                        <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                        <p>
                            <label>属性名称</label>
                            <input class="text-input" type="text"
                                   value="<?=isset($value['value_name']) ? $value['value_name'] : ''?>" name="value_name"/>
                            <input type="hidden" name="value_id" value="<?=isset($value['value_id']) ? $value['value_id'] : ''?>">
                            <!-- Classes for input-notification: success, error, information, attention -->
                            <small>属性值名称不可为空</small>
                        </p>
                        <label>所属属性</label>
                        <select name="attr_id" class="small-input">
