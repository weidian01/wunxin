    ...
    <div class="content-box">
        ...
        <div class="content-box-content">
            ...
            <div class="tab-content default-tab" id="tab1">
                <form action="<?=site_url('administrator/product_taobao/confirm2')?>" method="post">
                    <fieldset>
                        ...
                        <?php foreach($public['desc_img'] as $_img):?>
                         <tr>
                            <td><input type="checkbox" name="desc_img[]" value="<?=$_img?>" checked="checked"></td>
