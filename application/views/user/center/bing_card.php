...
<head>
    ...
    <style type="text/css">
        ...
        .btn_b1 { background: url("<?=config_item('static_url')?>images/btn_b2.gif") no-repeat scroll 0 0 transparent; border: 0 none; color: #FFFFFF; cursor: pointer; display: inline-block;
