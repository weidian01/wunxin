    ...
    <div class="hd-cont">
        ...
        <div class="cart" onmouseover="wx.cartView('cartbox', 1)" onmouseout="wx.cartView('cartbox', 0)">
            <div class="cart-num"> 购物车有
                <span class="font1" id="cart_product_num"> <img src="<?=url('static')?>images/small_loading.gif" alt=""/> </span> 件
            ...
            <div class="cart-btn"><a href="<?=url('cart')?>cart" >
                <!--<img src="<?=url('static')?>images/cart_31.jpg" width="60" height="24"/>-->
            </a></div>
        </div>
        <div class="hd-login">
            <ul>
                <li><a href="javascript:void (0);" onclick="wx.addFavorite()">收藏本站</a></li>
                <li><a href="<?=url('static')?>other/help/index/16" target="_blank">帮助中心</a></li>
                <!--<li><a href="#">浏览记录</a></li>-->
                <!--<li><a href="<?=url()?>user/center">我的万象</a></li>-->
                <li><a href="<?=url('order')?>user/center/index" target="_blank">我的订单</a></li>
                <li id="user_info_id"><a style="color:#000;" href="<?=url('member')?>user/register/" target="_blank">注册</a></li>
                <li id="user_login_out_id"><a href="<?=url('member')?>user/login/" target="_blank">登录</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="box">
    <div class="banner" style="overflow:auto; zoom:1">
        <!--
        <div class="logo-img"><a href="<?=url()?>"><img src="<?=url('static')?>images/logo.jpg" width="334" height="56" alt="万象网"/></a></div>
        <div class="search">
            <div class="s-input">
                <div class="sch">
                    <form name="search" method="get" action="<?=url('search')?>search">
            ...
            <div class="hot-keyword">
                <ul>
                    ...
                    <li><a href="<?=url('search')?>search?keyword=<?=$sk['title'];?>" target="_blank"><?=$sk['title'];?></a></li>
                    <?php endforeach;?>
        ...
        <div class="logo-img"><a href="<?=url()?>" title="万象网"><img src="<?=url('static')?>images/logo_03.jpg" width="267" height="66" /></a></div>
        <div class="search">
          <div class="s-input">
            <div class="sch">
                <form name="search" method="get" action="<?=url('search')?>search">
        ...
        <div class="cedt">
          <table width="92%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="29%"><img src="<?=url('static')?>images/wx_12.jpg" width="51" height="45" alt="正品保证" /></td>
              <td width="35%"><img src="<?=url('static')?>images/wx_14.jpg" width="62" height="45" alt="全场免运费" /></td>
              <td width="36%"><img src="<?=url('static')?>images/wx_17.jpg" width="74" height="44" alt="无理由退换货" /></td>
            </tr>
          </table>
        </div>
    </div>
...
<div class="nav">
    <div class="navbox">
        <div class="mainnav">
            <a <?php if(!isset($category) && !isset($keyword)):?>class="curr"<?php endif;?> href="<?=url()?>">首页</a>
            ...
            <a <?php if(isset($keyword) && $keyword == '裤'):?>class="curr"<?php endif;?> href="<?=url('search')?>search?keyword=<?=urlencode('裤')?>" class="last">裤装</a>
        </div>
        ...
        <div class="other">
            <div class="otherbox">
                <ul>
                    ...
                    <li><a href="<?=url()?>activity/activity/discount/19" target="_blank">特价热卖</a></li>
                    <li><a href="<?=url()?>comment/hot" target="_blank">热门评论</a></li>
                    <li class="end"><a href="<?=url()?>activity/activity/qiang/18" target="_blank">限时抢购</a></li>
                </ul>
            </div>
        </div>
    </div>
