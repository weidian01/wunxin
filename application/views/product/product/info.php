  ...
  <div class="goods-i">
    ...
    <div class="size">
      ...
      <div class="addcart">
          ...
          <a class="addcart-btn" href="javascript:;" onclick="addToCart();" id="add_to_cart" title="添加到购物车"></a>
          <?php else:?>
          <a class="past-due" href="javascript:;" title="产品已下架"></a>
          <?php endif;?>
          <!--<a class="addcart-btn" href="javascript:;" onclick="wx.addToCartLayer(<?=$product['pid'];?>, '<?=$product['pname'];?>', 'add_to_cart');" id="add_to_cart"></a>-->
          <a class="sc-btn" href="javascript:;" onclick="product.favoriteProduct(<?=$product['pid']?>, 'but_favorite')" id="but_favorite" title="收藏该产品"></a>
